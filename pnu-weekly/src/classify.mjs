...
const NEG = /^[\s'"‘’“”]*(?:이|가|을|를|은|는|도|만|의|에|과|와)?[\s'"‘’“”]*(없이|없는|없다|없어|없음|없었|없도록|없애|없앤|아닌|아니라|해소|불식|종식|막았|막은|막는|막기|방지|피했|피하|씻|잠재웠|덜었|덜어|줄였|제로|경감|완화|낮췄|낮춰|낮추|대응|극복|타개|돌파|활용|보다|부지)/;
