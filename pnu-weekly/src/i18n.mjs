...
const ko = {
  ...
  secVoicesSub: '기사 언급 집계 + 기관 공식 채널 · 개인 SNS 계정은 수집하지 않음',
  grpPersons: '인물 (직책 기준)', grpOrgs: '기관·단체',
  grpFeeds: '기관 공식 채널 최신 글',
...
const en = {
  ...
  secVoicesSub: 'article mentions + official institutional channels · personal social accounts are not collected',
  grpPersons: 'People (tracked by office)', grpOrgs: 'Institutions',
  grpFeeds: 'Latest from official channels',
